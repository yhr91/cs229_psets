\item \points{25} {\bf Bayesian Interpretation of Regularization}
...
\begin{enumerate}
    \input{bayesianreg/01-argmax}
\ifnum\solutions=1 {
  \input{bayesianreg/01-argmax-sol}
} \fi

    \input{bayesianreg/02-l2}
\ifnum\solutions=1 {
  \input{bayesianreg/02-l2-sol}
} \fi


    \input{bayesianreg/03-closed-form}
\ifnum\solutions=1 {
  \input{bayesianreg/03-closed-form-sol}
} \fi

 	\input{bayesianreg/04-coding}
\ifnum\solutions=1 {
	\input{bayesianreg/04-coding-sol}
} \fi


    \input{bayesianreg/05-l1}

\ifnum\solutions=1 {
  \input{bayesianreg/05-l1-sol}
} \fi
